...
class User(AbstractBaseUser):
    ...
    gender = models.CharField(max_length=10, choices=choices.GenderChoices.choices)
    user_type = models.CharField(
        max_length=10,
        choices=choices.UserTypeChoices.choices,
        default=choices.UserTypeChoices.FIRM_USER,
    )
...
class FirmUsers(BaseModel):
    ...
    role = models.CharField(
        max_length=50,
        choices=choices.UserRoleChoices.choices,
        null=True,
        blank=True
    )
